...
RM_STATUS   NV_API_CALL  os_alloc_mem                (void **, NvU64);
...
RM_STATUS   NV_API_CALL  os_set_mem_range            (NvU64, NvU64, NvU32, NvS32 *);
RM_STATUS   NV_API_CALL  os_unset_mem_range          (NvU64, NvU64, NvS32);
